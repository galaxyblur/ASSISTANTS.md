...
Pointers only. No secrets live here. This is the one place that knows every space the resident may enter, so only the entry for the space being visited ever travels (GIT.md §8).
