...
One way to enact the framework, with plain git and markdown files. It is not the only way. Where this document and the framework disagree, the framework wins and this document has a bug.
