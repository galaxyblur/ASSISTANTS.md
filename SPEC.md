...
- **Carry-out.** What may be written down outside the space afterwards.
  ...
  - `none`: nothing. An owner who needs something out changes the policy; the change is the record.
...
- A visitor is whoever is in a space, reading (or writing to the board): a person by hand, an agent, or an assistant.
